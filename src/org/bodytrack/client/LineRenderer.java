 ...
 *
 * <p>A LineRenderer maintains a highlighted point, as set by the
 ...
 * is called.  Other than this highlighted point, however, a LineRenderer
 * is logically immutable.  Hidden from the user of this object is a mutable
...
public class LineRenderer implements SeriesPlotRenderer {
	...
	/**
	 * Creates a new LineRenderer object
	 *
	 * @param highlighted
	 * 	True if this LineRenderer should draw in highlighted, thicker lines,
	 *  and false otherwise
	 * @param drawComments
	 * 	True if this LineRenderer should draw comment boxes, and false otherwise
	 */
	...
	protected void paintEdgePoint(final BoundedDrawingBox drawing,
		...
		if (drawComments && rawDataPoint.hasComment()) {
