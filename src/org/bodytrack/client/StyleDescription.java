...
public final class StyleDescription extends JavaScriptObject {
   ...
   public static final class StyleType extends JavaScriptObject {
       ...
       *         {@link ColorUtils#buildColor(String)} can't parse.
       */
       ...
       *
       * @param defaultColor
       *            The color to return if this style does not have a field
       *            with a name matching the value of the
       ...
       *         {@link ColorUtils#buildColor(String)} can't parse.
       */
      public CssColor getColorField(final String fieldName,
                                    final CssColor defaultColor) {
         final CssColor color = ColorUtils.getColor(
               this.<String>getValue(fieldName), defaultColor);
         return color;
      }

      /**
       * Returns the value of the <code>lineWidth</code> field, if such a
       * field exists, otherwise returns the given
       * <code>defaultLineWidth</code>.
       */
      ...
      /**
       * Returns whether the style should be filled. Defaults to
      ...
      public native double getDoubleValue(final String fieldName,
   ...
   public static final class CommentsDescription extends JavaScriptObject {
      ...
      /**
       * Returns the CSS class name applied to comment container elements. If
       * not defined, returns <code>null</code>.
       */
      ...
      /**
       * Returns the CSS class name applied to comment elements. If not
      ...
      /**
       * Returns the value of the given <code>fieldName</code>. If not
       * defined, returns <code>null</code>.
       */
      private native String getStringValue(final String fieldName) /*-{
         return (typeof this[fieldName] === 'undefined') ? null
               : this[fieldName];
      }-*/;

      /**
       * Returns the value of the <code>verticalMargin</code> field, if such a
       * field exists, otherwise returns the given
       * <code>defaultVerticalMargin</code>.
       */
